...
2. Next, let's build some linear models that predict nitrate concentrations at a USGS site on Menominee River (`MenomineeMajorIons` dataset from `smwrData`). Choose at least two, and as many as nine, explanatory variables that you think may be useful to predicting nitrate. Again save your model to an object and print the summary of that model to the screen. 
