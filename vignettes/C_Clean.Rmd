...
1)  Return to the code chunk in [Lesson B. Get](B_Get.html#reading-nwis-data-into-r) that accesses NWIS data. Modify that code chunk and add it to your R script to access phosphorus and also temperature ('00010') for NM. Save these data in data frames named using the variable name and state abbreviation, e.g., 'discharge_fl'. 
