...
2. Let's add another section to the script to create a pairs plot of the NM physical and water quality data we have collected so far (phosphorus, discharge, temperature, and specific conductance).
