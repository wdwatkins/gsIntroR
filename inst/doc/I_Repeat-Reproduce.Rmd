...
vignette: >
  ...
  %\VignetteIndexEntry{I. Repeat and Reproduce}
...
1. Our first task is to create a simple function.  This one is a bit contrived, but wanted let you try it first before we work on the NLA data (from "Visualize" lesson).  Create a function that allows you to calculate the mean or standard deviation (hint: sd()) of an input vector.
